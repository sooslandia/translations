...
Звук мяча также можно поменять прямо во время игры. Для этого войдите в режим наблюдения за мячом, зажав клавишу g, а затем нажимайте l для изменения звука.
...
| Узнать на какой высоте находится мяч | b |
