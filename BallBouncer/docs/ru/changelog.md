...
- Исправлены вылеты игры при тех случаях, когда активной программой чтения с экрана являлась не NVDA.

- Потенциально исправлен вылет игры, когда запись игровой сессии была включена.
